...
MANIFEST = [
    ...
    ('4_act3_beam', 23, 'CORE', 'timing_campaigns.png', 'Timing: the 20 ns goal is met on two of three stations',
     'SACLAY/P2_basket_analysis/mpgd2026/figs/timing_campaigns.png'),
    ('4_act3_beam', 23, 'CORE', 'timing_vs_drift_magboltz.png', 'Timing: the 20 ns goal is met on two of three stations',
     'SACLAY/P2_basket_analysis/reports/mpgd26_sps_beam_2026-08/figs/timing_vs_drift_magboltz.png'),
    ('4_act3_beam', 24, 'CORE', 'dream_vs_vmm.png', 'DREAM vs VMM3a on the same chambers',
     'SACLAY/P2_basket_analysis/mpgd2026/figs/dream_vs_vmm.png'),
    ('4_act3_beam', 25, 'CORE', 'vmm_threshold.png', 'That gap is the discriminator threshold — three independent handles',
     'SACLAY/P2_basket_analysis/mpgd2026/figs/vmm_threshold.png'),
    # The 19-Aug VMM work.  Two of these are on slides; the three tagged
    # NEW are gathered and proposed but not yet placed, so they keep
    # slide 0 (no prefix) rather than claiming a slide they are not on.
    ('4_act3_beam', 26, 'OPTIONAL', 'vmm_timing_peaks.png', 'The VMM coincidence time, per chamber and per gas',
     'SACLAY/P2_basket_analysis/mpgd2026/figs/vmm_timing_peaks.png'),
    ('4_act3_beam', 27, 'OPTIONAL', 'vmm_timing.png', 'The trigger costs more than the chamber — and the clock never mattered',
     'SACLAY/P2_basket_analysis/mpgd2026/figs/vmm_timing.png'),
    ('4_act3_beam', 0, 'NEW', 'adc_threshold_cost.png', 'proposed for slide 25: what the discriminator threshold costs, on the DREAM charge spectrum',
     'SACLAY/P2_basket_analysis/mpgd2026/figs/adc_threshold_cost.png'),
    ('4_act3_beam', 0, 'NEW', 'vmm_stability.png', 'proposed for slide 24: identical config/HV/gas 24 h apart — the VMM number drifts 3.6-10.3 points across a day',
     'SACLAY/P2_basket_analysis/mpgd2026/figs/vmm_stability.png'),
    ('6_backup', 0, 'NEW', 'vmm_timing_peaks_validation.png', 'backup for slides 26-27: the Gaussian-plus-background fits behind the quoted widths',
     'SACLAY/P2_basket_analysis/mpgd2026/figs/vmm_timing_peaks_validation.png'),
    ('5_optional', 30, 'OPTIONAL', 'eff_vs_mesh_urw.png', 'ε(HV) on the beam, on its own axes',
     'SACLAY/P2_basket_analysis/reports/mpgd26_sps_beam_2026-08/figs/eff_vs_mesh_urw.png'),
    ('5_optional', 30, 'OPTIONAL', 'eff_vs_drift_urw.png', 'ε(HV) on the beam, on its own axes',
     'SACLAY/P2_basket_analysis/reports/mpgd26_sps_beam_2026-08/figs/eff_vs_drift_urw.png'),
    ('5_optional', 31, 'OPTIONAL', 'timing_ladder.png', 'How the timing number is actually made',
     'SACLAY/P2_basket_analysis/reports/mpgd26_sps_beam_2026-08/figs/timing_ladder.png'),
    ('5_optional', 32, 'OPTIONAL', 'hv_campaign_timeline.png', 'The campaign in one picture',
     'SACLAY/P2_basket_analysis/reports/mpgd26_sps_beam_2026-08/figs/hv_campaign_timeline.png'),
    ('5_optional', 33, 'OPTIONAL', 'eff_vs_time_highstat_eff_1.png', 'Charging-up, caught in the act',
     'SACLAY/P2_basket_analysis/reports/mpgd26_sps_beam_2026-08/figs/eff_vs_time_highstat_eff_1.png'),
    ('5_optional', 34, 'OPTIONAL', 'vmm_turnon_gasAB.png', 'The gas change — predicted, then observed',
     'SACLAY/P2_basket_analysis/reports/mpgd26_sps_beam_2026-08/figs/vmm_turnon_gasAB.png'),
    ('5_optional', 35, 'OPTIONAL', 'eff_2d_drift_mesh_2d_2.png', 'The full (mesh, drift) efficiency surface',
     'SACLAY/P2_basket_analysis/reports/mpgd26_sps_beam_2026-08/figs/eff_2d_drift_mesh_2d_2.png'),
    ('5_optional', 35, 'OPTIONAL', 'timing_2d_drift_mesh_2d_2.png', 'The full (mesh, drift) efficiency surface',
     'SACLAY/P2_basket_analysis/reports/mpgd26_sps_beam_2026-08/figs/timing_2d_drift_mesh_2d_2.png'),
    ('5_optional', 36, 'OPTIONAL', 'eff_methods_comparison.png', 'Three methods, one answer',
     'SACLAY/P2_basket_analysis/reports/mpgd26_sps_beam_2026-08/figs/eff_methods_comparison.png'),
    ('5_optional', 37, 'OPTIONAL', 'spark_summary.png', 'Sparks and HV health across twelve days',
     'SACLAY/P2_basket_analysis/reports/mpgd26_sps_beam_2026-08/figs/spark_summary.png'),
    ('5_optional', 39, 'OPTIONAL', 'eff_p2in_swap.png', 'Three chambers passed through P2_IN — the CERN-built one is the last',
     'SACLAY/P2_basket_analysis/reports/mpgd26_sps_beam_2026-08/figs/eff_p2in_swap.png'),
    ('5_optional', 40, 'OPTIONAL', 'vmm_config_scan.png', 'The VMM configuration scan — what to actually set',
     'SACLAY/P2_basket_analysis/reports/mpgd26_sps_beam_2026-08/figs/vmm_config_scan.png'),
    ('5_optional', 41, 'OPTIONAL', '07_all_mesh_scans.png', 'Bench detail: all four detectors, every scan',
     'SACLAY/data/Cosmic_Bench/Analysis/conference/07_all_mesh_scans.png'),
    ('5_optional', 41, 'OPTIONAL', '08_all_drift_scans.png', 'Bench detail: all four detectors, every scan',
     'SACLAY/data/Cosmic_Bench/Analysis/conference/08_all_drift_scans.png'),
    ('5_optional', 41, 'OPTIONAL', '06_coverage_table.png', 'Bench detail: all four detectors, every scan',
     'SACLAY/data/Cosmic_Bench/Analysis/conference/06_coverage_table.png'),
    ('6_backup', 46, 'BACKUP', '04_det1_timing_vs_drift.png', 'Q: "Why is your bench timing so much worse than your beam timing?"',
     'SACLAY/data/Cosmic_Bench/Analysis/conference/04_det1_timing_vs_drift.png'),
    ('6_backup', 47, 'BACKUP', '10_det1_loss_budget.png', 'Q: "How do you know the inefficiency is not the gas?"',
     'SACLAY/data/Cosmic_Bench/Analysis/conference/10_det1_loss_budget.png'),
    ('6_backup', 50, 'BACKUP', 'gas_drift_velocity.png', 'Reference: the gas study behind the mixture choice',
     'SACLAY/P2_basket_analysis/gas_studies/figs/drift_velocity_vs_dV.png'),
    ('6_backup', 50, 'BACKUP', 'gas_timing_floor.png', 'Reference: the gas study behind the mixture choice',
     'SACLAY/P2_basket_analysis/gas_studies/figs/timing_floor_vs_driftHV.png'),
    ('6_backup', 51, 'BACKUP', 'drift_ladder_trajectory.png', 'Reference: the det3 autopsy in one figure',
     'SACLAY/P2_basket_analysis/reports/det_lifetime_autopsy_2026-07/figs/drift_ladder_trajectory.png'),
    # --- reworked / split for the talk (2026-08-19) ----------------------- #
    ('4_act3_beam', 17, 'CORE', 'urw_residuals_P2_MID.png',
     'The absolute measurement: how well reference and cluster agree',
     'SACLAY/P2_basket_analysis/reports/mpgd26_sps_beam_2026-08/figs/urw_residuals_P2_MID.png'),
    ('4_act3_beam', 17, 'CORE', 'urw_efficiency_P2_MID.png',
     'The absolute measurement: efficiency mapped in both frames',
     'SACLAY/P2_basket_analysis/reports/mpgd26_sps_beam_2026-08/figs/urw_efficiency_P2_MID.png'),
    ('4_act3_beam', 17, 'OPTIONAL', 'urw_acceptance_P2_MID.png',
     'The absolute measurement: what went into the number',
     'SACLAY/P2_basket_analysis/reports/mpgd26_sps_beam_2026-08/figs/urw_acceptance_P2_MID.png'),
    ('4_act3_beam', 20, 'CORE', 'padmap_working_point_surface.png',
     'Per-pad efficiency as a surface - is what is left uniform?',
     'SACLAY/P2_basket_analysis/reports/mpgd26_sps_beam_2026-08/figs/padmap_working_point_surface.png'),
    ('4_act3_beam', 21, 'CORE', 'bench_beam_mesh_all.png',
     'Every chamber, both campaigns: efficiency vs mesh',
     'SACLAY/P2_basket_analysis/mpgd2026/figs/bench_beam_mesh_all.png'),
    ('4_act3_beam', 21, 'OPTIONAL', 'bench_beam_drift_all.png',
     'Every chamber, both campaigns: efficiency vs drift',
     'SACLAY/P2_basket_analysis/mpgd2026/figs/bench_beam_drift_all.png'),
    ('6_backup', 21, 'BACKUP', 'bench_beam_grid.png',
     'Bench and beam chamber by chamber, including what was never measured',
     'SACLAY/P2_basket_analysis/mpgd2026/figs/bench_beam_grid.png'),
    ('5_optional', 31, 'OPTIONAL', 'timing_vs_mesh_bothruns.png',
     'How the timing number is actually made',
    ...
    ('4_act3_beam', 22, 'CORE', 'bench_beam_drift.png',
     '…and the transport half: the same two chambers, in two laboratories',
     'SACLAY/P2_basket_analysis/mpgd2026/figs/bench_beam_drift.png'),
    ('4_act3_beam', 42, 'OPTIONAL', 'bench_beam_maps.png',
     'The same map, made two ways',
    ...
    ('5_optional', 48, 'BACKUP', 'timing_2d_curves_vs_drift_drift_mesh_2d_2.png',
     'Q: "Did you pick the right drift field for timing?"',
     'SACLAY/P2_basket_analysis/reports/mpgd26_sps_beam_2026-08/figs/'
     'timing_2d_curves_vs_drift_drift_mesh_2d_2.png'),
    ('5_optional', 48, 'BACKUP', 'timing_drift_choice_table_drift_mesh_2d_2.png',
     'Q: "Did you pick the right drift field for timing?"',
     'SACLAY/P2_basket_analysis/reports/mpgd26_sps_beam_2026-08/figs/'
    ...
    ('4_act3_beam', 38, 'OPTIONAL', 'rate_performance.png',
     'Rate: efficiency is flat, and the fake-match background is not the problem yet',
     'SACLAY/P2_basket_analysis/reports/mpgd26_sps_beam_2026-08/figs/'
     'rate_performance.png'),
    ('4_act3_beam', 28, 'CORE', 'twotrack_side.png',
     'The three planes tracking on their own — and what that costs',
...
def write_inventory(figdir):
    ...
    for act in sorted(acts):
        ...
        for _, slide, tag, name, title, src in acts[act]:
            if title:
                where = f'slide {slide}: ' if slide else 'not on a slide — '
                lines.append(f'- **{name}** — {where}{title}')
        lines.append('')
